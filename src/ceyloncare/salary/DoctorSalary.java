...
public class DoctorSalary extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(lbSalary, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 104, 220, 27));
        ...
        jPanel2.add(lbDays, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 55, 193, 27));
        ...
        jPanel2.add(lbNetSalary, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 113, 191, 35));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        this.hide();
         // Reset all the fields by calling the same form again
        DoctorSalary frm = new DoctorSalary();
        frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorSalary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
