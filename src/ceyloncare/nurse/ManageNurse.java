 ...
 */
public class ManageNurse extends javax.swing.JFrame {
    Connection con = null;
    ResultSet rs = null;
     ...
     * @param ch
     */
    public ManageNurse(String ch) {
        initComponents();
        setLocationRelativeTo(null);
        choice=ch;
        
        // Generates new emp_id for each new nurse record
        this.generateID();
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try{
            ...
            String name,salary,email,contact,id,nic,address,date;
            ...
            + email + "','"+ cmbGen.getSelectedItem().toString()+ "','" + date + "','Nurse','"+salary+"')";

            // Query to insert data into nurse table
            String query3="INSERT INTO nurse VALUES('"+id+"','"+txtQualifications.getText()+"')";
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            if (x==0)
            {
                ...
                // Query to delete details from nurse table
                String query2= "DELETE FROM nurse WHERE emp_id = '" + txtID.getText() + "'";
    ...
    // To update details regarding a particular nurse
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            con=Connect.ConnectDB();
            
            // Query to update details in nurse table
            String query1= "UPDATE nurse "
            + "SET emp_id='" + txtID.getText() + "',nurse_qualifications='" + txtQualifications.getText()
    ...
    private void btnGetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGetDataActionPerformed
        this.hide();
        // Load NurseRecord form to select already inserted nurse details
        NurseRecord frm = new NurseRecord(choice);
        frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageNurse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageNurse("").setVisible(true);
            }
        });
    }
